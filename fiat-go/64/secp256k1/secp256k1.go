...
//
// Autogenerated: 'src/ExtractionOCaml/word_by_word_montgomery' --lang Go --no-wide-int --relax-primitive-carry-to-bitwidth 32,64 --cmovznz-by-mul --internal-static --package-case flatcase --public-function-case UpperCamelCase --private-function-case camelCase --public-type-case UpperCamelCase --private-type-case camelCase --no-prefix-fiat --doc-newline-in-typedef-bounds --doc-prepend-header 'Code generated by Fiat Cryptography. DO NOT EDIT.' --doc-text-before-function-name '' --doc-text-before-type-name '' --package-name secp256k1 '' 64 '2^256 - 2^32 - 977' mul square add sub opp from_montgomery to_montgomery nonzero selectznz to_bytes from_bytes one msat sat_from_bytes divstep divstep_precomp inner_loop inner_loop_hd update_fg update_vr jumpdivstep_precomp jumpdivstep_precomp_hd
//
...
func UpdateVr(out1 *[4]uint64, out2 *[4]uint64, arg1 *[4]uint64, arg2 *[4]uint64, arg3 uint64, arg4 uint64, arg5 uint64, arg6 uint64) {
	...
	var x12 uint64
	var x13 uint64
	x12, x13 = bits.Add64(x3, (x11 & 0xfffffffefffffc2f), uint64(0x0))
	var x14 uint64
	var x15 uint64
	x14, x15 = bits.Add64(x5, x11, uint64(uint1(x13)))
	var x16 uint64
	var x17 uint64
	x16, x17 = bits.Add64(x7, x11, uint64(uint1(x15)))
	var x18 uint64
	x18, _ = bits.Add64(x9, x11, uint64(uint1(x17)))
	var x20 uint64
	...
	var x35 uint64
	var x36 uint64
	x35, x36 = bits.Add64(x26, (x34 & 0xfffffffefffffc2f), uint64(0x0))
	var x37 uint64
	var x38 uint64
	x37, x38 = bits.Add64(x28, x34, uint64(uint1(x36)))
	var x39 uint64
	var x40 uint64
	x39, x40 = bits.Add64(x30, x34, uint64(uint1(x38)))
	var x41 uint64
	x41, _ = bits.Add64(x32, x34, uint64(uint1(x40)))
	var x43 uint64
	...
	var x58 uint64
	var x59 uint64
	x58, x59 = bits.Add64(x49, (x57 & 0xfffffffefffffc2f), uint64(0x0))
	var x60 uint64
	var x61 uint64
	x60, x61 = bits.Add64(x51, x57, uint64(uint1(x59)))
	var x62 uint64
	var x63 uint64
	x62, x63 = bits.Add64(x53, x57, uint64(uint1(x61)))
	var x64 uint64
	x64, _ = bits.Add64(x55, x57, uint64(uint1(x63)))
	var x66 uint64
	...
	var x81 uint64
	var x82 uint64
	x81, x82 = bits.Add64(x72, (x80 & 0xfffffffefffffc2f), uint64(0x0))
	var x83 uint64
	var x84 uint64
	x83, x84 = bits.Add64(x74, x80, uint64(uint1(x82)))
	var x85 uint64
	var x86 uint64
	x85, x86 = bits.Add64(x76, x80, uint64(uint1(x84)))
	var x87 uint64
	x87, _ = bits.Add64(x78, x80, uint64(uint1(x86)))
	var x89 uint64
	...
	var x108 uint64
	_, x108 = bits.Mul64(x99, 0xd838091dd2253531)
	var x110 uint64
	var x111 uint64
	x111, x110 = bits.Mul64(x108, 0xffffffffffffffff)
	var x112 uint64
	var x113 uint64
	x113, x112 = bits.Mul64(x108, 0xffffffffffffffff)
	var x114 uint64
	var x115 uint64
	x115, x114 = bits.Mul64(x108, 0xffffffffffffffff)
	var x116 uint64
	var x117 uint64
	x117, x116 = bits.Mul64(x108, 0xfffffffefffffc2f)
	var x118 uint64
	var x119 uint64
	...
	var x160 uint64
	_, x160 = bits.Mul64(x150, 0xd838091dd2253531)
	var x162 uint64
	var x163 uint64
	x163, x162 = bits.Mul64(x160, 0xffffffffffffffff)
	var x164 uint64
	var x165 uint64
	x165, x164 = bits.Mul64(x160, 0xffffffffffffffff)
	var x166 uint64
	var x167 uint64
	x167, x166 = bits.Mul64(x160, 0xffffffffffffffff)
	var x168 uint64
	var x169 uint64
	x169, x168 = bits.Mul64(x160, 0xfffffffefffffc2f)
	var x170 uint64
	var x171 uint64
	...
	var x213 uint64
	_, x213 = bits.Mul64(x203, 0xd838091dd2253531)
	var x215 uint64
	var x216 uint64
	x216, x215 = bits.Mul64(x213, 0xffffffffffffffff)
	var x217 uint64
	var x218 uint64
	x218, x217 = bits.Mul64(x213, 0xffffffffffffffff)
	var x219 uint64
	var x220 uint64
	x220, x219 = bits.Mul64(x213, 0xffffffffffffffff)
	var x221 uint64
	var x222 uint64
	x222, x221 = bits.Mul64(x213, 0xfffffffefffffc2f)
	var x223 uint64
	var x224 uint64
	...
	var x266 uint64
	_, x266 = bits.Mul64(x256, 0xd838091dd2253531)
	var x268 uint64
	var x269 uint64
	...
	var x274 uint64
	var x275 uint64
	x275, x274 = bits.Mul64(x266, 0xfffffffefffffc2f)
	var x276 uint64
	var x277 uint64
	...
	var x294 uint64
	var x295 uint64
	x294, x295 = bits.Sub64(x285, 0xfffffffefffffc2f, uint64(0x0))
	var x296 uint64
	var x297 uint64
	x296, x297 = bits.Sub64(x287, 0xffffffffffffffff, uint64(uint1(x295)))
	var x298 uint64
	var x299 uint64
	x298, x299 = bits.Sub64(x289, 0xffffffffffffffff, uint64(uint1(x297)))
	var x300 uint64
	var x301 uint64
	x300, x301 = bits.Sub64(x291, 0xffffffffffffffff, uint64(uint1(x299)))
	var x303 uint64
	...
	var x323 uint64
	_, x323 = bits.Mul64(x314, 0xd838091dd2253531)
	var x325 uint64
	var x326 uint64
	x326, x325 = bits.Mul64(x323, 0xffffffffffffffff)
	var x327 uint64
	var x328 uint64
	x328, x327 = bits.Mul64(x323, 0xffffffffffffffff)
	var x329 uint64
	var x330 uint64
	x330, x329 = bits.Mul64(x323, 0xffffffffffffffff)
	var x331 uint64
	var x332 uint64
	x332, x331 = bits.Mul64(x323, 0xfffffffefffffc2f)
	var x333 uint64
	var x334 uint64
	...
	var x375 uint64
	_, x375 = bits.Mul64(x365, 0xd838091dd2253531)
	var x377 uint64
	var x378 uint64
	x378, x377 = bits.Mul64(x375, 0xffffffffffffffff)
	var x379 uint64
	var x380 uint64
	x380, x379 = bits.Mul64(x375, 0xffffffffffffffff)
	var x381 uint64
	var x382 uint64
	x382, x381 = bits.Mul64(x375, 0xffffffffffffffff)
	var x383 uint64
	var x384 uint64
	x384, x383 = bits.Mul64(x375, 0xfffffffefffffc2f)
	var x385 uint64
	var x386 uint64
	...
	var x428 uint64
	_, x428 = bits.Mul64(x418, 0xd838091dd2253531)
	var x430 uint64
	var x431 uint64
	x431, x430 = bits.Mul64(x428, 0xffffffffffffffff)
	var x432 uint64
	var x433 uint64
	x433, x432 = bits.Mul64(x428, 0xffffffffffffffff)
	var x434 uint64
	var x435 uint64
	x435, x434 = bits.Mul64(x428, 0xffffffffffffffff)
	var x436 uint64
	var x437 uint64
	x437, x436 = bits.Mul64(x428, 0xfffffffefffffc2f)
	var x438 uint64
	var x439 uint64
	...
	var x481 uint64
	_, x481 = bits.Mul64(x471, 0xd838091dd2253531)
	var x483 uint64
	var x484 uint64
	x484, x483 = bits.Mul64(x481, 0xffffffffffffffff)
	var x485 uint64
	var x486 uint64
	x486, x485 = bits.Mul64(x481, 0xffffffffffffffff)
	var x487 uint64
	var x488 uint64
	x488, x487 = bits.Mul64(x481, 0xffffffffffffffff)
	var x489 uint64
	var x490 uint64
	x490, x489 = bits.Mul64(x481, 0xfffffffefffffc2f)
	var x491 uint64
	var x492 uint64
	...
	var x509 uint64
	var x510 uint64
	x509, x510 = bits.Sub64(x500, 0xfffffffefffffc2f, uint64(0x0))
	var x511 uint64
	var x512 uint64
	x511, x512 = bits.Sub64(x502, 0xffffffffffffffff, uint64(uint1(x510)))
	var x513 uint64
	var x514 uint64
	x513, x514 = bits.Sub64(x504, 0xffffffffffffffff, uint64(uint1(x512)))
	var x515 uint64
	var x516 uint64
	x515, x516 = bits.Sub64(x506, 0xffffffffffffffff, uint64(uint1(x514)))
	var x518 uint64
	...
	var x538 uint64
	_, x538 = bits.Mul64(x529, 0xd838091dd2253531)
	var x540 uint64
	var x541 uint64
	x541, x540 = bits.Mul64(x538, 0xffffffffffffffff)
	var x542 uint64
	var x543 uint64
	x543, x542 = bits.Mul64(x538, 0xffffffffffffffff)
	var x544 uint64
	var x545 uint64
	x545, x544 = bits.Mul64(x538, 0xffffffffffffffff)
	var x546 uint64
	var x547 uint64
	x547, x546 = bits.Mul64(x538, 0xfffffffefffffc2f)
	var x548 uint64
	var x549 uint64
	...
	var x590 uint64
	_, x590 = bits.Mul64(x580, 0xd838091dd2253531)
	var x592 uint64
	var x593 uint64
	x593, x592 = bits.Mul64(x590, 0xffffffffffffffff)
	var x594 uint64
	var x595 uint64
	x595, x594 = bits.Mul64(x590, 0xffffffffffffffff)
	var x596 uint64
	var x597 uint64
	x597, x596 = bits.Mul64(x590, 0xffffffffffffffff)
	var x598 uint64
	var x599 uint64
	x599, x598 = bits.Mul64(x590, 0xfffffffefffffc2f)
	var x600 uint64
	var x601 uint64
	...
	var x643 uint64
	_, x643 = bits.Mul64(x633, 0xd838091dd2253531)
	var x645 uint64
	var x646 uint64
	x646, x645 = bits.Mul64(x643, 0xffffffffffffffff)
	var x647 uint64
	var x648 uint64
	x648, x647 = bits.Mul64(x643, 0xffffffffffffffff)
	var x649 uint64
	var x650 uint64
	x650, x649 = bits.Mul64(x643, 0xffffffffffffffff)
	var x651 uint64
	var x652 uint64
	x652, x651 = bits.Mul64(x643, 0xfffffffefffffc2f)
	var x653 uint64
	var x654 uint64
	...
	var x696 uint64
	_, x696 = bits.Mul64(x686, 0xd838091dd2253531)
	var x698 uint64
	var x699 uint64
	x699, x698 = bits.Mul64(x696, 0xffffffffffffffff)
	var x700 uint64
	var x701 uint64
	x701, x700 = bits.Mul64(x696, 0xffffffffffffffff)
	var x702 uint64
	var x703 uint64
	x703, x702 = bits.Mul64(x696, 0xffffffffffffffff)
	var x704 uint64
	var x705 uint64
	x705, x704 = bits.Mul64(x696, 0xfffffffefffffc2f)
	var x706 uint64
	var x707 uint64
	...
	var x724 uint64
	var x725 uint64
	x724, x725 = bits.Sub64(x715, 0xfffffffefffffc2f, uint64(0x0))
	var x726 uint64
	var x727 uint64
	x726, x727 = bits.Sub64(x717, 0xffffffffffffffff, uint64(uint1(x725)))
	var x728 uint64
	var x729 uint64
	x728, x729 = bits.Sub64(x719, 0xffffffffffffffff, uint64(uint1(x727)))
	var x730 uint64
	var x731 uint64
	x730, x731 = bits.Sub64(x721, 0xffffffffffffffff, uint64(uint1(x729)))
	var x733 uint64
	...
	var x753 uint64
	_, x753 = bits.Mul64(x744, 0xd838091dd2253531)
	var x755 uint64
	var x756 uint64
	x756, x755 = bits.Mul64(x753, 0xffffffffffffffff)
	var x757 uint64
	var x758 uint64
	x758, x757 = bits.Mul64(x753, 0xffffffffffffffff)
	var x759 uint64
	var x760 uint64
	x760, x759 = bits.Mul64(x753, 0xffffffffffffffff)
	var x761 uint64
	var x762 uint64
	x762, x761 = bits.Mul64(x753, 0xfffffffefffffc2f)
	var x763 uint64
	var x764 uint64
	...
	var x805 uint64
	_, x805 = bits.Mul64(x795, 0xd838091dd2253531)
	var x807 uint64
	var x808 uint64
	x808, x807 = bits.Mul64(x805, 0xffffffffffffffff)
	var x809 uint64
	var x810 uint64
	x810, x809 = bits.Mul64(x805, 0xffffffffffffffff)
	var x811 uint64
	var x812 uint64
	x812, x811 = bits.Mul64(x805, 0xffffffffffffffff)
	var x813 uint64
	var x814 uint64
	x814, x813 = bits.Mul64(x805, 0xfffffffefffffc2f)
	var x815 uint64
	var x816 uint64
	...
	var x858 uint64
	_, x858 = bits.Mul64(x848, 0xd838091dd2253531)
	var x860 uint64
	var x861 uint64
	x861, x860 = bits.Mul64(x858, 0xffffffffffffffff)
	var x862 uint64
	var x863 uint64
	x863, x862 = bits.Mul64(x858, 0xffffffffffffffff)
	var x864 uint64
	var x865 uint64
	x865, x864 = bits.Mul64(x858, 0xffffffffffffffff)
	var x866 uint64
	var x867 uint64
	x867, x866 = bits.Mul64(x858, 0xfffffffefffffc2f)
	var x868 uint64
	var x869 uint64
	...
	var x911 uint64
	_, x911 = bits.Mul64(x901, 0xd838091dd2253531)
	var x913 uint64
	var x914 uint64
	x914, x913 = bits.Mul64(x911, 0xffffffffffffffff)
	var x915 uint64
	var x916 uint64
	x916, x915 = bits.Mul64(x911, 0xffffffffffffffff)
	var x917 uint64
	var x918 uint64
	x918, x917 = bits.Mul64(x911, 0xffffffffffffffff)
	var x919 uint64
	var x920 uint64
	x920, x919 = bits.Mul64(x911, 0xfffffffefffffc2f)
	var x921 uint64
	var x922 uint64
	...
	var x939 uint64
	var x940 uint64
	x939, x940 = bits.Sub64(x930, 0xfffffffefffffc2f, uint64(0x0))
	var x941 uint64
	var x942 uint64
	x941, x942 = bits.Sub64(x932, 0xffffffffffffffff, uint64(uint1(x940)))
	var x943 uint64
	var x944 uint64
	x943, x944 = bits.Sub64(x934, 0xffffffffffffffff, uint64(uint1(x942)))
	var x945 uint64
	var x946 uint64
	x945, x946 = bits.Sub64(x936, 0xffffffffffffffff, uint64(uint1(x944)))
	var x948 uint64
	...
	var x961 uint64
	var x962 uint64
	x961, x962 = bits.Sub64(x953, 0xfffffffefffffc2f, uint64(0x0))
	var x963 uint64
	var x964 uint64
	x963, x964 = bits.Sub64(x955, 0xffffffffffffffff, uint64(uint1(x962)))
	var x965 uint64
	var x966 uint64
	x965, x966 = bits.Sub64(x957, 0xffffffffffffffff, uint64(uint1(x964)))
	var x967 uint64
	var x968 uint64
	x967, x968 = bits.Sub64(x959, 0xffffffffffffffff, uint64(uint1(x966)))
	var x970 uint64
	...
	var x983 uint64
	var x984 uint64
	x983, x984 = bits.Sub64(x975, 0xfffffffefffffc2f, uint64(0x0))
	var x985 uint64
	var x986 uint64
	x985, x986 = bits.Sub64(x977, 0xffffffffffffffff, uint64(uint1(x984)))
	var x987 uint64
	var x988 uint64
	x987, x988 = bits.Sub64(x979, 0xffffffffffffffff, uint64(uint1(x986)))
	var x989 uint64
	var x990 uint64
	x989, x990 = bits.Sub64(x981, 0xffffffffffffffff, uint64(uint1(x988)))
	var x992 uint64
