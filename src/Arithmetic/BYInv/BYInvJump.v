...
Proof.
  ...
  - replace (Z.of_nat (S n)) with (Z.of_nat n + 1) in * by lia.
    ...
    + rewrite Zmod_odd, twos_complement_opp_odd by (try assumption; lia). cbn -[Z.mul Z.add].
      ...
      * rewrite Z.twos_complement_mod, Z.twos_complement_add_full, twos_complement_opp_spec, Z.twos_complement_one;
          try rewrite ?twos_complement_opp_spec, ?Z.twos_complement_one; lia.
      * rewrite Z.arithmetic_shiftr1_spec by (try apply Z.mod_pos_bound; lia).
...
Proof.
  ...
  - replace (Z.of_nat (S n)) with (Z.of_nat n + 1) in * by lia.
    ...
    + rewrite Zmod_odd, twos_complement_opp_odd by (try assumption; lia).
      ...
      * rewrite Z.twos_complement_mod, Z.twos_complement_add_full, twos_complement_opp_spec, Z.twos_complement_one by
            (try rewrite twos_complement_opp_spec, Z.twos_complement_one; lia); lia.
      *
...
Proof.
  ...
  - cbn -[Z.pow Z.mul Z.add Z.of_nat].
    ...
    unfold divstep_spec_full, divstep_spec_full'.
    inversion H.
    inversion IHn; subst.
...
Module WordByWordMontgomery.
  ...
  Section __.
    ...
    Notation outer_loop_body := (outer_loop_body machine_wordsize n sat_limbs word_tc_mul_limbs m m').
...
Module UnsaturatedSolinas.
  ...
  Section __.
    ...
    Notation outer_loop_body := (outer_loop_body limbwidth_num limbwidth_den machine_wordsize s c n sat_limbs word_tc_mul_limbs idxs balance).
