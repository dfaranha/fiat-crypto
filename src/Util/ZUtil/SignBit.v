...
Module Z.
  ...
  Proof.
    ...
    - rewrite Z.land_pow2_testbit, Z.bits_above_log2; lia.
  Qed.
  ...
  Proof.
    rewrite <- (Z.mod_small _ _ Ha) at 2.
    rewrite Z.twos_complement_cond_equiv, sign_bit_testbit, negb_involutive; lia.
  Qed.
  ...
  Proof.
    ...
    intro H; apply sign_bit_0_land_pow2 in H.
    rewrite Z.land_pow2_testbit in H;
  ...
  Lemma sign_bit_twos_complement a m
        (mw0 : 0 < m)
        (Ha : 0 <= a < 2 ^ m) :
    Z.sign_bit m a = Z.b2z (Z.twos_complement m a <? 0).
  Proof.
    now rewrite Z.sign_bit_testbit, Z.twos_complement_neg_equiv, Z.twos_complement_cond_equiv, Bool.negb_involutive.
  Qed.
End Z.
