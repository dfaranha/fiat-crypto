...
Module Z.
  ...
  Proof.
    ...
    assert (0 <= a mod 2 ^ m < 2 ^ m) by (apply Z.mod_pos_bound; lia). unfold Z.twos_complement. brute_force_ineq. Qed.
  ...
  Proof. assert (0 < 2 ^ m) by (apply Z.pow_pos_nonneg; lia).
         ...
         apply twos_complement_spec; try split; rewrite ?Z.mod_0_l; try lia. Qed.
