/* Autogenerated: src/ExtractionOCaml/bedrock2_unsaturated_solinas --lang bedrock2 --static --no-wide-int --widen-carry --widen-bytes --split-multiret --no-select p521 64 9 '2^521 - 1' carry_mul carry_square carry add sub opp selectznz to_bytes from_bytes one sat_from_bytes */
/* curve description: p521 */
/* machine_wordsize = 64 (from "64") */
/* requested operations: carry_mul, carry_square, carry, add, sub, opp, selectznz, to_bytes, from_bytes, one, sat_from_bytes */
/* n = 9 (from "9") */
...
void internal_fiat_p521_to_bytes(uintptr_t out0, uintptr_t in0) {
  ...
  x69 = ((uintptr_t)-1ULL)+((x68)==((uintptr_t)0ULL));
  ...
  x77 = (x76)<((x69)&((uintptr_t)288230376151711743ULL));
  x78 = (x75)+(x77);
  ...
  x84 = (x83)<((x69)&((uintptr_t)288230376151711743ULL));
  x85 = (x82)+(x84);
  ...
  x91 = (x90)<((x69)&((uintptr_t)288230376151711743ULL));
  x92 = (x89)+(x91);
  ...
  x98 = (x97)<((x69)&((uintptr_t)288230376151711743ULL));
  x99 = (x96)+(x98);
  ...
  x105 = (x104)<((x69)&((uintptr_t)288230376151711743ULL));
  x106 = (x103)+(x105);
  ...
  x112 = (x111)<((x69)&((uintptr_t)288230376151711743ULL));
  x113 = (x110)+(x112);
  ...
  x119 = (x118)<((x69)&((uintptr_t)288230376151711743ULL));
  x120 = (x117)+(x119);
