/* Autogenerated: src/ExtractionOCaml/bedrock2_unsaturated_solinas --lang bedrock2 --static --no-wide-int --widen-carry --widen-bytes --split-multiret --no-select p448 64 8 '2^448 - 2^224 - 1' carry_mul carry_square carry add sub opp selectznz to_bytes from_bytes one sat_from_bytes */
...
void internal_fiat_p448_to_bytes(uintptr_t out0, uintptr_t in0) {
  ...
  x61 = ((uintptr_t)-1ULL)+((x60)==((uintptr_t)0ULL));
  ...
  x69 = (x68)<((x61)&((uintptr_t)72057594037927935ULL));
  x70 = (x67)+(x69);
  ...
  x76 = (x75)<((x61)&((uintptr_t)72057594037927935ULL));
  x77 = (x74)+(x76);
  ...
  x83 = (x82)<((x61)&((uintptr_t)72057594037927935ULL));
  x84 = (x81)+(x83);
  ...
  x90 = (x89)<((x61)&((uintptr_t)72057594037927934ULL));
  x91 = (x88)+(x90);
  ...
  x97 = (x96)<((x61)&((uintptr_t)72057594037927935ULL));
  x98 = (x95)+(x97);
  ...
  x104 = (x103)<((x61)&((uintptr_t)72057594037927935ULL));
  x105 = (x102)+(x104);
