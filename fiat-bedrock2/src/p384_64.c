/* Autogenerated: src/ExtractionOCaml/bedrock2_word_by_word_montgomery --lang bedrock2 --static --no-wide-int --widen-carry --widen-bytes --split-multiret --no-select p384 64 '2^384 - 2^128 - 2^96 + 2^32 - 1' mul square add sub opp from_montgomery to_montgomery nonzero selectznz to_bytes from_bytes one sat_from_bytes */
...
void internal_fiat_p384_sub(uintptr_t out0, uintptr_t in0, uintptr_t in1) {
  ...
  x30 = (x29)+(x23);
  x31 = (((x29)<(x18))+((x30)<(x23)))+(x20);
  x32 = (x31)+(x23);
  x33 = ((((x31)<(x20))+((x32)<(x23)))+(x22))+(x23);
  x34 = x24;
  x35 = x26;
  x36 = x28;
  x37 = x30;
...
void internal_fiat_p384_opp(uintptr_t out0, uintptr_t in0) {
  ...
  x24 = (x23)+(x17);
  x25 = (((x23)<(x12))+((x24)<(x17)))+(x14);
  x26 = (x25)+(x17);
  x27 = ((((x25)<(x14))+((x26)<(x17)))+(x16))+(x17);
  x28 = x18;
  x29 = x20;
  x30 = x22;
  x31 = x24;
...
void internal_fiat_p384_from_montgomery(uintptr_t out0, uintptr_t in0) {
  ...
  x251 = (x239)<((x239)-(((x238)<(x249))+((x249)<(x250))));
...
void internal_fiat_p384_to_montgomery(uintptr_t out0, uintptr_t in0) {
  ...
  x371 = (x359)<((x359)-(((x358)<(x369))+((x369)<(x370))));
...
static void fiat_p384_nonzero(uint64_t* out1, const uint64_t arg1[6]) {
  *out1 = internal_fiat_p384_nonzero((uintptr_t)arg1);
}
