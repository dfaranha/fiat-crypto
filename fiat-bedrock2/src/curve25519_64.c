/* Autogenerated: src/ExtractionOCaml/bedrock2_unsaturated_solinas --lang bedrock2 --static --no-wide-int --widen-carry --widen-bytes --split-multiret --no-select 25519 64 '(auto)' '2^255 - 19' carry_mul carry_square carry add sub opp selectznz to_bytes from_bytes one sat_from_bytes carry_scmul121666 */
/* curve description: 25519 */
/* machine_wordsize = 64 (from "64") */
/* requested operations: carry_mul, carry_square, carry, add, sub, opp, selectznz, to_bytes, from_bytes, one, sat_from_bytes, carry_scmul121666 */
/* n = 5 (from "(auto)") */
...
void internal_fiat_25519_to_bytes(uintptr_t out0, uintptr_t in0) {
  ...
  x45 = (x44)<((x37)&((uintptr_t)2251799813685247ULL));
  x46 = (x43)+(x45);
  ...
  x52 = (x51)<((x37)&((uintptr_t)2251799813685247ULL));
  x53 = (x50)+(x52);
  ...
  x59 = (x58)<((x37)&((uintptr_t)2251799813685247ULL));
  x60 = (x57)+(x59);
