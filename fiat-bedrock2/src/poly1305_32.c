/* Autogenerated: 'src/ExtractionOCaml/bedrock2_unsaturated_solinas' --lang bedrock2 --static --no-wide-int --widen-carry --widen-bytes --split-multiret --no-select --no-field-element-typedefs poly1305 32 '(auto)' '2^130 - 5' carry_mul carry_square carry add sub opp selectznz to_bytes from_bytes one relax sat_from_bytes jumpdivstep_precomp_hd */
 ...
 */
static
void internal_fiat_poly1305_one(uintptr_t out0) {
...
/* NOTE: The following wrapper function is not covered by Coq proofs */
static void fiat_poly1305_one(uint32_t out1[5]) {
  internal_fiat_poly1305_one((uintptr_t)out1);
}
...
/*
 * Input Bounds:
 *   in0: [[0x0 ~> 0xff], [0x0 ~> 0xff], [0x0 ~> 0xff], [0x0 ~> 0xff], [0x0 ~> 0xff], [0x0 ~> 0xff], [0x0 ~> 0xff], [0x0 ~> 0xff], [0x0 ~> 0xff], [0x0 ~> 0xff], [0x0 ~> 0xff], [0x0 ~> 0xff], [0x0 ~> 0xff], [0x0 ~> 0xff], [0x0 ~> 0xff], [0x0 ~> 0xff], [0x0 ~> 0xff]]
 * Output Bounds:
 *   out0: [[0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff]]
 */
static
void internal_fiat_poly1305_sat_from_bytes(uintptr_t out0, uintptr_t in0) {
  uintptr_t x16, x15, x14, x13, x12, x11, x10, x9, x8, x7, x6, x5, x4, x3, x2, x1, x0, x32, x33, x31, x34, x30, x35, x28, x29, x27, x37, x26, x38, x24, x25, x23, x40, x22, x41, x20, x21, x19, x43, x18, x44, x36, x39, x42, x45, x17, x46, x47, x48, x49, x50, x51;
  x0 = _br2_load((in0)+((uintptr_t)0ULL), 1);
  x1 = _br2_load((in0)+((uintptr_t)1ULL), 1);
  x2 = _br2_load((in0)+((uintptr_t)2ULL), 1);
  x3 = _br2_load((in0)+((uintptr_t)3ULL), 1);
  ...
  /*skip*/
  x17 = x16;
  x18 = (x15)<<((uintptr_t)24ULL);
  x19 = (x14)<<((uintptr_t)16ULL);
  x20 = (x13)<<((uintptr_t)8ULL);
  x21 = x12;
  x22 = (x11)<<((uintptr_t)24ULL);
  x23 = (x10)<<((uintptr_t)16ULL);
  x24 = (x9)<<((uintptr_t)8ULL);
  x25 = x8;
  x26 = (x7)<<((uintptr_t)24ULL);
  x27 = (x6)<<((uintptr_t)16ULL);
  x28 = (x5)<<((uintptr_t)8ULL);
  x29 = x4;
  x30 = (x3)<<((uintptr_t)24ULL);
  x31 = (x2)<<((uintptr_t)16ULL);
  x32 = (x1)<<((uintptr_t)8ULL);
...
static void fiat_poly1305_sat_from_bytes(uint32_t out1[6], const uint8_t arg1[17]) {
  internal_fiat_poly1305_sat_from_bytes((uintptr_t)out1, (uintptr_t)arg1);
}
 ...
 */
static
void internal_fiat_poly1305_jumpdivstep_precomp_hd(uintptr_t out0) {
  uintptr_t x0, x1, x2, x3, x4;
  /*skip*/
  x0 = (uintptr_t)37580961ULL;
  x1 = (uintptr_t)2684354ULL;
  x2 = (uintptr_t)48855255ULL;
  x3 = (uintptr_t)50465865ULL;
  x4 = (uintptr_t)38117834ULL;
  /*skip*/
  _br2_store((out0)+((uintptr_t)0ULL), x0, sizeof(uintptr_t));
  _br2_store((out0)+((uintptr_t)4ULL), x1, sizeof(uintptr_t));
  _br2_store((out0)+((uintptr_t)8ULL), x2, sizeof(uintptr_t));
...
static void fiat_poly1305_jumpdivstep_precomp_hd(uint32_t out1[5]) {
  internal_fiat_poly1305_jumpdivstep_precomp_hd((uintptr_t)out1);
}
