/* Autogenerated: src/ExtractionOCaml/bedrock2_unsaturated_solinas --lang bedrock2 --static --no-wide-int --widen-carry --widen-bytes --split-multiret --no-select poly1305 64 3 '2^130 - 5' carry_mul carry_square carry add sub opp selectznz to_bytes from_bytes one sat_from_bytes */
...
void internal_fiat_poly1305_to_bytes(uintptr_t out0, uintptr_t in0) {
  ...
  x21 = ((uintptr_t)-1ULL)+((x20)==((uintptr_t)0ULL));
  ...
  x29 = (x28)<((x21)&((uintptr_t)8796093022207ULL));
  x30 = (x27)+(x29);
