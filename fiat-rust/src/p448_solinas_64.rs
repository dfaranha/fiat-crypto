//! Autogenerated: src/ExtractionOCaml/unsaturated_solinas --lang Rust p448 64 8 '2^448 - 2^224 - 1' carry_mul carry_square carry add sub opp selectznz to_bytes from_bytes one msat sat_from_bytes divstep divstep_precomp jumpdivstep_precomp outer_loop_body
